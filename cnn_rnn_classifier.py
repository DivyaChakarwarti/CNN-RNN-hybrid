...
model.fit_generator(train_generator, samples_per_epoch=44, nb_epoch=nb_epochs, verbose=1,
...
print("DIVYAKUJAYAASHILUBHANI")
model.fit_generator(train_generator, samples_per_epoch=22, nb_epoch=nb_epochs, verbose=1,
                    validation_data=val_generator,
                    nb_val_samples=nb_val_samples,
                    callbacks=[tensorboard_callback, checkpointer])
